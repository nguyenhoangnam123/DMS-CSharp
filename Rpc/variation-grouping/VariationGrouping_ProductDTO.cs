...
{
    public class VariationGrouping_ProductDTO : DataDTO
    {
        ...
        public VariationGrouping_ProductDTO() {}
        public VariationGrouping_ProductDTO(Product Product)
        {
    ...
    public class VariationGrouping_ProductFilterDTO : FilterDTO
    {
