...
namespace DMS.Enums
{
    public class KpiCriteriaGeneralEnum
    {
        ...
        public static GenericEnum STORE_VISITED = new GenericEnum { Id = 5, Code = "StoresVisited", Name = "Số cửa hàng viếng thăm" };
        public static GenericEnum NEW_STORE_CREATED = new GenericEnum { Id = 6, Code = "NewStoresCreated", Name = "Số cửa hàng tạo mới" };
        public static GenericEnum NUMBER_OF_STORE_VISIT = new GenericEnum { Id = 7, Code = "NumberOfStoreVisits", Name = "Số lần viếng thăm cửa hàng" };
