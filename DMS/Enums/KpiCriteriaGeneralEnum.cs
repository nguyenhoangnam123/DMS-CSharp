...
namespace DMS.Enums
{
    public class KpiCriteriaGeneralEnum
    {
        ...
        {
            TOTAL_INDIRECT_SALES_ORDER, TOTAL_INDIRECT_SALES_QUANTITY, TOTAL_INDIRECT_SALES_AMOUNT, SKU_INDIRECT_SALES_ORDER, STORE_VISITED, NEW_STORE_CREATED, NUMBER_OF_STORE_VISIT,
        };
    }
}
