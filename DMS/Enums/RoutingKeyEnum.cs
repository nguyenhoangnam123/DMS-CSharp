...
namespace DMS.Enums
{
    public class RoutingKeyEnum
    {
        ...
        public static GenericEnum UpdateGPS = new GenericEnum { Id = 10, Code = "AppUser.UpdateGPS", Name = "Update GPS" };
        ...
        public static GenericEnum ShowingCategoryUsed = new GenericEnum { Id = 121, Code = "DMS.ShowingCategory.Used", Name = "ShowingCategory Used" };
    }
}