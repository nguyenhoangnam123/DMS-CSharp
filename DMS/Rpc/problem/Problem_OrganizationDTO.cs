...
{
    public class Problem_OrganizationDTO : DataDTO
    {
        ...
        public Problem_OrganizationDTO() { }
        public Problem_OrganizationDTO(Organization Organization)
        {
    ...
    public class Problem_OrganizationFilterDTO : FilterDTO
    {
