...
{
    public class DirectSalesOrderPromotion_DirectSalesOrderDTO : DataDTO
    {
        ...
        public DirectSalesOrderPromotion_DirectSalesOrderDTO() {}
        public DirectSalesOrderPromotion_DirectSalesOrderDTO(DirectSalesOrder DirectSalesOrder)
        {
    ...
    public class DirectSalesOrderPromotion_DirectSalesOrderFilterDTO : FilterDTO
    {
