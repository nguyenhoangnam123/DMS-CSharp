...
namespace DMS.Rpc.indirect_sales_order
{
    public class IndirectSalesOrder_IndirectSalesOrderContentDTO : DataDTO
    {
        ...
        public IndirectSalesOrder_ItemDTO IndirectSalesOrderNavigation { get; set; }   
        ...
        public IndirectSalesOrder_IndirectSalesOrderContentDTO(IndirectSalesOrderContent IndirectSalesOrderContent)
        {
            ...
            this.IndirectSalesOrderNavigation = IndirectSalesOrderContent.IndirectSalesOrderNavigation == null ? null : new IndirectSalesOrder_ItemDTO(IndirectSalesOrderContent.IndirectSalesOrderNavigation);
