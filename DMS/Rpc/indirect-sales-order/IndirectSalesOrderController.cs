    ...
    public class IndirectSalesOrderController : RpcController
    {
        ...
        public async Task<ActionResult> Import(IFormFile file)
        {
            ...
            using (ExcelPackage excelPackage = new ExcelPackage(file.OpenReadStream()))
            {
                ...
                int BuyerStoreIdColumn = 1 + StartColumn;
                int PhoneNumberColumn = 2 + StartColumn;
                int StoreAddressColumn = 3 + StartColumn;
                int DeliveryAddressColumn = 4 + StartColumn;
                int SellerStoreIdColumn = 5 + StartColumn;
                int SaleEmployeeIdColumn = 6 + StartColumn;
                int OrderDateColumn = 7 + StartColumn;
                int DeliveryDateColumn = 8 + StartColumn;
                int IndirectSalesOrderStatusIdColumn = 9 + StartColumn;
                int IsEditedPriceColumn = 10 + StartColumn;
                ...
                for (int i = StartRow; i <= worksheet.Dimension.End.Row; i++)
                {
                    ...
                    string IsEditedPriceValue = worksheet.Cells[i + StartRow, IsEditedPriceColumn].Value?.ToString();
            ...
            else
            {
                ...
                for (int i = 0; i < IndirectSalesOrders.Count; i++)
                {
                    ...
                    if (!IndirectSalesOrder.IsValidated)
                    {
                        ...
                        if (IndirectSalesOrder.Errors.ContainsKey(nameof(IndirectSalesOrder.IsEditedPrice)))
                            Error += IndirectSalesOrder.Errors[nameof(IndirectSalesOrder.IsEditedPrice)];
            ...
            using (ExcelPackage excel = new ExcelPackage(memoryStream))
            {
                ...
                for (int i = 0; i < IndirectSalesOrders.Count; i++)
                {
                    ...
                    data.Add(new Object[]
                    {
                        ...
                        IndirectSalesOrder.IsEditedPrice,
                    ...
                    excel.GenerateWorksheet("IndirectSalesOrder", IndirectSalesOrderHeaders, data);
                }
                excel.Save();
            }
        ...
        private IndirectSalesOrder ConvertDTOToEntity(IndirectSalesOrder_IndirectSalesOrderDTO IndirectSalesOrder_IndirectSalesOrderDTO)
        {
            ...
            IndirectSalesOrder.IsEditedPrice = IndirectSalesOrder_IndirectSalesOrderDTO.IsEditedPrice;
            ...
            IndirectSalesOrder.SaleEmployee = IndirectSalesOrder_IndirectSalesOrderDTO.SaleEmployee == null ? null : new AppUser
            {
                ...
                RowId = IndirectSalesOrder_IndirectSalesOrderDTO.SaleEmployee.RowId,
