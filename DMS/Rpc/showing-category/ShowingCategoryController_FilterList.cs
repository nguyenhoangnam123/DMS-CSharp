...
namespace DMS.Rpc.showing_category
{
    ...
    {
        [Route(ShowingCategoryRoute.FilterListImage), HttpPost]
        public async Task<List<ShowingCategory_ImageDTO>> FilterListImage([FromBody] ShowingCategory_ImageFilterDTO ShowingCategory_ImageFilterDTO)
        {
        ...
        [Route(ShowingCategoryRoute.FilterListCategory), HttpPost]
        public async Task<List<ShowingCategory_CategoryDTO>> FilterListCategory([FromBody] ShowingCategory_CategoryFilterDTO ShowingCategory_CategoryFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
