...
namespace DMS.Rpc.dashboards.mobile
{
    public class DashboardMobileController : SimpleController
    {
        ...
        public async Task<long> CountStoreChecking([FromBody] DashboardMobile_FilterDTO filter)
        {
        ...
        public async Task<long> CountStore([FromBody] DashboardMobile_FilterDTO filter)
        {
            DateTime Now = StaticParams.DateTimeNow;
            DateTime Start = new DateTime(Now.Year, Now.Month, 1).AddHours(0 - CurrentContext.TimeZone);
            DateTime End = new DateTime(Now.AddHours(CurrentContext.TimeZone).Year, Now.AddHours(CurrentContext.TimeZone).Month, 1).AddHours(0 - CurrentContext.TimeZone);
        ...
        public async Task<long> CountIndirectSalesOrder([FromBody] DashboardMobile_FilterDTO filter)
        {
        ...
        public async Task<decimal> IndirectSalesOrderRevenue([FromBody] DashboardMobile_FilterDTO filter)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<DashboardMobile_TopRevenueBySalesEmployeeDTO>> TopIndirectSaleEmployeeRevenue([FromBody] DashboardMobile_FilterDTO filter)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<DashboardMobile_TopRevenueByItemDTO>> TopIndirecItemRevenue([FromBody] DashboardMobile_TopRevenueByItemFilterDTO filter)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<DashboardMobile_RevenueGrowthDTO> IndirectRevenueGrowth([FromBody] DashboardMobile_RevenueGrowthFilterDTO filter)
        {
                ...
                || filter.Time.Equal.Value == THIS_MONTH)
            {
                ...
                DashboardMobile_RevenueGrowthDTO RevenueGrowthDTO = new DashboardMobile_RevenueGrowthDTO();
                RevenueGrowthDTO.IndirectRevenueGrowthByMonths = new List<DashboardMobile_RevenueGrowthByMonthDTO>();
            ...
            else if (filter.Time.Equal.Value == THIS_QUARTER)
            {
                ...
                var Transactions = await query.ToListAsync();
                DashboardMobile_RevenueGrowthDTO RevenueGrowthDTO = new DashboardMobile_RevenueGrowthDTO();
                RevenueGrowthDTO.IndirectRevenueGrowthByQuaters = new List<DashboardMobile_RevenueGrowthByQuarterDTO>();
            ...
            else if (filter.Time.Equal.Value == YEAR)
            {
                ...
                var Transactions = await query.ToListAsync();
                DashboardMobile_RevenueGrowthDTO RevenueGrowthDTO = new DashboardMobile_RevenueGrowthDTO();
                RevenueGrowthDTO.IndirectRevenueGrowthByYears = new List<DashboardMobile_RevenueGrowthByYearDTO>();
                for (int i = 1; i <= 12; i++)
                {
        ...
        public async Task<DashboardMobile_QuantityGrowthDTO> IndirectSalesOrderGrowth([FromBody] DashboardMobile_QuantityGrowthFilterDTO filter)
        {
                ...
                || filter.Time.Equal.Value == THIS_MONTH)
            {
                ...
                DashboardMobile_QuantityGrowthDTO QuantityGrowthDTO = new DashboardMobile_QuantityGrowthDTO();
                QuantityGrowthDTO.IndirectSalesOrderQuantityGrowthByMonths = new List<DashboardMobile_QuantityGrowthByMonthDTO>();
                var number_of_day_in_this_month = DateTime.DaysInMonth(Start.AddHours(CurrentContext.TimeZone).Year, Start.AddHours(CurrentContext.TimeZone).Month);
                for (int i = 1; i < number_of_day_in_this_month + 1; i++)
                {
            ...
            else if (filter.Time.Equal.Value == THIS_QUARTER)
            {
                ...
                var OrderGrowthByMonthDTOs = await query.ToListAsync();
                DashboardMobile_QuantityGrowthDTO QuantityGrowthDTO = new DashboardMobile_QuantityGrowthDTO();
                QuantityGrowthDTO.IndirectSalesOrderQuantityGrowthByQuaters = new List<DashboardMobile_QuantityGrowthByQuarterDTO>();
                int start = 3 * (this_quarter - 1) + 1;
                int end = start + 3;
                for (int i = start; i < end; i++)
                {
            ...
            else if (filter.Time.Equal.Value == YEAR)
            {
                ...
                var OrderGrowthByMonthDTOs = await query.ToListAsync();
                DashboardMobile_QuantityGrowthDTO QuantityGrowthDTO = new DashboardMobile_QuantityGrowthDTO();
                QuantityGrowthDTO.IndirectSalesOrderQuantityGrowthByYears = new List<DashboardMobile_QuantityGrowthByYearDTO>();
                for (int i = 1; i <= 12; i++)
                {
        ...
        [Route(DashboardMobileRoute.DirectRevenueGrowth), HttpPost]
        public async Task<DashboardMobile_RevenueGrowthDTO> DirectRevenueGrowth([FromBody] DashboardMobile_RevenueGrowthFilterDTO filter)
        {
            DateTime Now = StaticParams.DateTimeNow;
            DateTime Start = LocalStartDay(CurrentContext);
            DateTime End = LocalEndDay(CurrentContext);
                ...
                || filter.Time.Equal.Value == THIS_MONTH)
            {
                ...
                DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByMonths = new List<DashboardMobile_RevenueGrowthByMonthDTO>();
                var number_of_day_in_this_month = DateTime.DaysInMonth(Start.AddHours(CurrentContext.TimeZone).Year, Start.AddHours(CurrentContext.TimeZone).Month);
                for (int i = 1; i < number_of_day_in_this_month + 1; i++)
                {
                    DashboardMobile_RevenueGrowthByMonthDTO RevenueGrowthByMonth = new DashboardMobile_RevenueGrowthByMonthDTO
                    ...
                    DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByMonths.Add(RevenueGrowthByMonth);
                }

                foreach (var RevenueGrowthByMonth in DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByMonths)
                {
                    DateTime LocalStart = new DateTime(Now.AddHours(CurrentContext.TimeZone).Year, Now.AddHours(CurrentContext.TimeZone).Month, (int)RevenueGrowthByMonth.Day).AddHours(0 - CurrentContext.TimeZone);
                    DateTime LocalEnd = LocalStart.AddHours(CurrentContext.TimeZone).AddDays(1).AddSeconds(-1).AddHours(0 - CurrentContext.TimeZone);
            ...
            else if (filter.Time.Equal.Value == THIS_QUARTER)
            {
                ...
                var DirectSalesOrderTransactionDAOs = await query.ToListAsync();
                DashboardMobile_RevenueGrowthDTO DashboardMobile_RevenueGrowthDTO = new DashboardMobile_RevenueGrowthDTO();
                DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByQuaters = new List<DashboardMobile_RevenueGrowthByQuarterDTO>();
                int start = 3 * (this_quarter - 1) + 1;
                int end = start + 3;
                for (int i = start; i < end; i++)
                {
            ...
            else if (filter.Time.Equal.Value == YEAR)
            {
                ...
                var DirectSalesOrderTransactionDAOs = await query.ToListAsync();
                DashboardMobile_RevenueGrowthDTO DashboardMobile_RevenueGrowthDTO = new DashboardMobile_RevenueGrowthDTO();
                DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByYears = new List<DashboardMobile_RevenueGrowthByYearDTO>();
                for (int i = 1; i <= 12; i++)
                {
                    DashboardMobile_RevenueGrowthByYearDTO RevenueGrowthByYear = new DashboardMobile_RevenueGrowthByYearDTO
                    {
                    ...
                    DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByYears.Add(RevenueGrowthByYear);
                }

                foreach (var RevenueGrowthByYear in DashboardMobile_RevenueGrowthDTO.DirectRevenueGrowthByYears)
                {
                    DateTime LocalStart = new DateTime(Now.AddHours(CurrentContext.TimeZone).Year, (int)RevenueGrowthByYear.Month, 1).AddHours(0 - CurrentContext.TimeZone);
                    DateTime LocalEnd = LocalStart.AddHours(CurrentContext.TimeZone).AddMonths(1).AddSeconds(-1).AddHours(0 - CurrentContext.TimeZone);
        ...
        [Route(DashboardMobileRoute.DirectQuantityGrowth), HttpPost]
        public async Task<DashboardMobile_QuantityGrowthDTO> DirectQuantityGrowth([FromBody] DashboardMobile_QuantityGrowthFilterDTO filter)
        {
            DateTime Now = StaticParams.DateTimeNow;
            DateTime Start = LocalStartDay(CurrentContext);
            DateTime End = LocalEndDay(CurrentContext);
                ...
                || filter.Time.Equal.Value == THIS_MONTH)
            {
                ...
                var DashboardMobile_DirectSalesOrderGrowthByMonthDTOs = await query.ToListAsync();
                DashboardMobile_QuantityGrowthDTO DashboardMobile_QuantityGrowthDTO = new DashboardMobile_QuantityGrowthDTO();
                DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByMonths = new List<DashboardMobile_QuantityGrowthByMonthDTO>();
                var number_of_day_in_this_month = DateTime.DaysInMonth(Start.AddHours(CurrentContext.TimeZone).Year, Start.AddHours(CurrentContext.TimeZone).Month);
                for (int i = 1; i < number_of_day_in_this_month + 1; i++)
                {
                    DashboardMobile_QuantityGrowthByMonthDTO DirectSalesOrderQuantityGrowthByMonth = new DashboardMobile_QuantityGrowthByMonthDTO
                    {
                        Day = i,
                        DirectSalesOrderCounter = 0
                    };
                    DashboardMobile_QuantityGrowthDTO.IndirectSalesOrderQuantityGrowthByMonths.Add(DirectSalesOrderQuantityGrowthByMonth);
                }

                foreach (var DirectSalesOrderGrowthByMonth in DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByMonths)
                {
                    var data = DashboardMobile_DirectSalesOrderGrowthByMonthDTOs.Where(x => x.Day == DirectSalesOrderGrowthByMonth.Day).FirstOrDefault();
                    if (data != null)
                        DirectSalesOrderGrowthByMonth.IndirectSalesOrderCounter = data.IndirectSalesOrderCounter;
                }
            ...
            else if (filter.Time.Equal.Value == LAST_MONTH)
            {
                ...
                foreach (var IndirectSalesOrderGrowthByMonth in DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByMonths)
                {
                    var data = DashboardMobile_DirectSalesOrderGrowthByMonthDTOs.Where(x => x.Day == IndirectSalesOrderGrowthByMonth.Day).FirstOrDefault();
                    if (data != null)
                        IndirectSalesOrderGrowthByMonth.IndirectSalesOrderCounter = data.IndirectSalesOrderCounter;
                }
            ...
            else if (filter.Time.Equal.Value == THIS_QUARTER)
            {
                ...
                var DashboardMobile_DirectSalesOrderGrowthByQuarterDTOs = await query.ToListAsync();
                DashboardMobile_QuantityGrowthDTO DashboardMobile_QuantityGrowthDTO = new DashboardMobile_QuantityGrowthDTO();
                DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByQuaters = new List<DashboardMobile_QuantityGrowthByQuarterDTO>();
                int start = 3 * (this_quarter - 1) + 1;
                int end = start + 3;
                for (int i = start; i < end; i++)
                {
                    DashboardMobile_QuantityGrowthByQuarterDTO DirectSalesOrderQuantityGrowthByQuarter = new DashboardMobile_QuantityGrowthByQuarterDTO
                    {
                        Month = i,
                        IndirectSalesOrderCounter = 0
                    };
                    DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByQuaters.Add(DirectSalesOrderQuantityGrowthByQuarter);
                }

                foreach (var DirectSalesOrderGrowthByQuater in DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByQuaters)
                {
                    var data = DashboardMobile_DirectSalesOrderGrowthByQuarterDTOs.Where(x => x.Month == DirectSalesOrderGrowthByQuater.Month).FirstOrDefault();
                    if (data != null)
                        DirectSalesOrderGrowthByQuater.IndirectSalesOrderCounter = data.IndirectSalesOrderCounter;
                }
            ...
            else if (filter.Time.Equal.Value == LAST_QUATER)
            {
                ...
                for (int i = start; i < end; i++)
                {
                    DashboardMobile_QuantityGrowthByQuarterDTO DirectSalesOrderGrowthByQuarter = new DashboardMobile_QuantityGrowthByQuarterDTO
                    {
                        Month = i,
                        DirectSalesOrderCounter = 0
                    };
                    DashboardMobile_QuantityGrowthDTO.IndirectSalesOrderQuantityGrowthByQuaters.Add(DirectSalesOrderGrowthByQuarter);
                }
            ...
            else if (filter.Time.Equal.Value == YEAR)
            {
                ...
                DashboardMobile_QuantityGrowthDTO DashboardMobile_QuantityGrowthDTO = new DashboardMobile_QuantityGrowthDTO();
                DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByYears = new List<DashboardMobile_QuantityGrowthByYearDTO>();
                for (int i = 1; i <= 12; i++)
                {
                    DashboardMobile_QuantityGrowthByYearDTO DirectSalesOrderGrowthByYear = new DashboardMobile_QuantityGrowthByYearDTO
                    {
                        Month = i,
                        IndirectSalesOrderCounter = 0
                    };
                    DashboardMobile_QuantityGrowthDTO.DirectSalesOrderQuantityGrowthByYears.Add(DirectSalesOrderGrowthByYear);
                }

                foreach (var DirectSalesOrderGrowthByYear in DashboardMobile_QuantityGrowthDTO.IndirectSalesOrderQuantityGrowthByYears)
                {
                    var data = DashboardMobile_DirectSalesOrderGrowthByYearDTO.Where(x => x.Month == DirectSalesOrderGrowthByYear.Month).FirstOrDefault();
                    if (data != null)
                        DirectSalesOrderGrowthByYear.IndirectSalesOrderCounter = data.IndirectSalesOrderCounter;
                }
