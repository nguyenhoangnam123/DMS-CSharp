...
{
    public class IndirectSalesOrderContent_UnitOfMeasureDTO : DataDTO
    {
        ...
        public IndirectSalesOrderContent_UnitOfMeasureDTO() {}
        public IndirectSalesOrderContent_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class IndirectSalesOrderContent_UnitOfMeasureFilterDTO : FilterDTO
    {
