...
{
    public class IndirectSalesOrderContent_IndirectSalesOrderContentDTO : DataDTO
    {
        ...
        public IndirectSalesOrderContent_IndirectSalesOrderContentDTO(IndirectSalesOrderContent IndirectSalesOrderContent)
        {
    ...
    public class IndirectSalesOrderContent_IndirectSalesOrderContentFilterDTO : FilterDTO
    {
