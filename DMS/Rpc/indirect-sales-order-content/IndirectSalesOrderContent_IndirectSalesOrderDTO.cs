...
{
    public class IndirectSalesOrderContent_IndirectSalesOrderDTO : DataDTO
    {
        ...
        public IndirectSalesOrderContent_IndirectSalesOrderDTO() {}
        public IndirectSalesOrderContent_IndirectSalesOrderDTO(IndirectSalesOrder IndirectSalesOrder)
        {
    ...
    public class IndirectSalesOrderContent_IndirectSalesOrderFilterDTO : FilterDTO
    {
