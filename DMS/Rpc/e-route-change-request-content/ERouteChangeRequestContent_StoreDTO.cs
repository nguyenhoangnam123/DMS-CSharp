...
{
    public class ERouteChangeRequestContent_StoreDTO : DataDTO
    {
        ...
        public ERouteChangeRequestContent_StoreDTO() {}
        public ERouteChangeRequestContent_StoreDTO(Store Store)
        {
    ...
    public class ERouteChangeRequestContent_StoreFilterDTO : FilterDTO
    {
