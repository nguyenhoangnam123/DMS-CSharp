            ...
            using (ExcelPackage excel = new ExcelPackage(MemoryStream))
            {
                ...
                for (int i = 0; i < Products.Count; i++)
                {
                    ...
                    data.Add(new object[]
                    {
                        ...
                        Product.Name,
                        ProductGroupingName,
                        Product.ProductType.Name == null ? null : Product.ProductType.Name,
                        Product.UnitOfMeasure.Name == null ? null : Product.UnitOfMeasure.Name,
                        Product.UnitOfMeasureGrouping.Name == null ? null : Product.UnitOfMeasureGrouping.Name,
                        Product.Supplier.Name == null ? null : Product.Supplier.Name,
                        Product.ERPCode,
                        Product.ScanCode,
                        Product.Brand.Name == null ? null : Product.Brand.Name,
                        Product.OtherName,
