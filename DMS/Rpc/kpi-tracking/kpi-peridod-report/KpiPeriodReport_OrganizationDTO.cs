...
{
    public class KpiPeriodReport_OrganizationDTO : DataDTO
    {
        ...
        public KpiPeriodReport_OrganizationDTO() { }
        public KpiPeriodReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class KpiPeriodReport_OrganizationFilterDTO : FilterDTO
    {
