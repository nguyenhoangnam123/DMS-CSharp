...
{
    public class StoreChecking_TaxTypeDTO : DataDTO
    {
        ...
        public StoreChecking_TaxTypeDTO() { }
        public StoreChecking_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class StoreChecking_TaxTypeFilterDTO : FilterDTO
    {
