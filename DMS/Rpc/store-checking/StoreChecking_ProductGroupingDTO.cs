...
{
    public class StoreChecking_ProductGroupingDTO : DataDTO
    {
        ...
        public StoreChecking_ProductGroupingDTO() { }
        public StoreChecking_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class StoreChecking_ProductGroupingFilterDTO : FilterDTO
    {
