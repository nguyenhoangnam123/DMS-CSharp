...
{
    public class StoreChecking_AppUserDTO : DataDTO
    {
        ...
        public StoreChecking_AppUserDTO() {}
        public StoreChecking_AppUserDTO(AppUser AppUser)
        {
    ...
    public class StoreChecking_AppUserFilterDTO : FilterDTO
    {
