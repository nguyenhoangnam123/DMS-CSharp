...
namespace DMS.Rpc.store_checking
{
    public class Mobile_ProductDTO : DataDTO
    {
        ...
        public StoreChecking_ProductTypeDTO ProductType { get; set; }
        public StoreChecking_SupplierDTO Supplier { get; set; }
        public StoreChecking_TaxTypeDTO TaxType { get; set; }
        ...
        public Mobile_ProductDTO(Product Product)
        {
            ...
            this.ProductType = Product.ProductType == null ? null : new StoreChecking_ProductTypeDTO(Product.ProductType);
            this.Supplier = Product.Supplier == null ? null : new StoreChecking_SupplierDTO(Product.Supplier);
            this.TaxType = Product.TaxType == null ? null : new StoreChecking_TaxTypeDTO(Product.TaxType);
            this.UnitOfMeasure = Product.UnitOfMeasure == null ? null : new StoreChecking_UnitOfMeasureDTO(Product.UnitOfMeasure);
            this.UnitOfMeasureGrouping = Product.UnitOfMeasureGrouping == null ? null : new StoreChecking_UnitOfMeasureGroupingDTO(Product.UnitOfMeasureGrouping);
            this.ProductProductGroupingMappings = Product.ProductProductGroupingMappings?.Select(x => new StoreChecking_ProductProductGroupingMappingDTO(x)).ToList();
            this.Errors = Product.Errors;
        }
    }

    public class StoreChecking_ProductFilterDTO : FilterDTO
    {
