...
{
    public class StoreChecking_UnitOfMeasureDTO : DataDTO
    {
        ...
        public StoreChecking_UnitOfMeasureDTO() { }
        public StoreChecking_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
        ...
        public StoreChecking_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
    ...
    public class StoreChecking_UnitOfMeasureFilterDTO : FilterDTO
    {
