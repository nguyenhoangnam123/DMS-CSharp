...
{
    public class StoreChecking_StoreGroupingDTO : DataDTO
    {
        ...
        public StoreChecking_StoreGroupingDTO() { }
        public StoreChecking_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class StoreChecking_StoreGroupingFilterDTO : FilterDTO
    {
