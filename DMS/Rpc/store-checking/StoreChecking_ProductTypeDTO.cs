...
{
    public class StoreChecking_ProductTypeDTO : DataDTO
    {
        ...
        public StoreChecking_ProductTypeDTO() { }
        public StoreChecking_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class StoreChecking_ProductTypeFilterDTO : FilterDTO
    {
