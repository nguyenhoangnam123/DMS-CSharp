...
{
    public class KpiPeriod_OrganizationDTO : DataDTO
    {
        ...
        public KpiPeriod_OrganizationDTO() {}
        public KpiPeriod_OrganizationDTO(Organization Organization)
        {
    ...
    public class KpiPeriod_OrganizationFilterDTO : FilterDTO
    {
