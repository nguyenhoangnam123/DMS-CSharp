...
{
    public class ItemSpecificKpi_AppUserDTO : DataDTO
    {
        ...
        public ItemSpecificKpi_AppUserDTO() {}
        public ItemSpecificKpi_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ItemSpecificKpi_AppUserFilterDTO : FilterDTO
    {
