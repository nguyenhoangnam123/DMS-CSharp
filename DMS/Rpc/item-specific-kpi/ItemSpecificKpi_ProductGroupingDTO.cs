...
{
    public class ItemSpecificKpi_ProductGroupingDTO : DataDTO
    {
        ...
        public ItemSpecificKpi_ProductGroupingDTO() { }
        public ItemSpecificKpi_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class ItemSpecificKpi_ProductGroupingFilterDTO : FilterDTO
    {
