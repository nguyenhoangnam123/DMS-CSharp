...
{
    public class ItemSpecificKpi_OrganizationDTO : DataDTO
    {
        ...
        public ItemSpecificKpi_OrganizationDTO() {}
        public ItemSpecificKpi_OrganizationDTO(Organization Organization)
        {
    ...
    public class ItemSpecificKpi_OrganizationFilterDTO : FilterDTO
    {
