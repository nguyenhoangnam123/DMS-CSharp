...
namespace DMS.Rpc.kpi_product_grouping_content
{
    ...
    {
        [Route(KpiProductGroupingContentRoute.FilterListKpiProductGrouping), HttpPost]
        public async Task<List<KpiProductGroupingContent_KpiProductGroupingDTO>> FilterListKpiProductGrouping([FromBody] KpiProductGroupingContent_KpiProductGroupingFilterDTO KpiProductGroupingContent_KpiProductGroupingFilterDTO)
        {
