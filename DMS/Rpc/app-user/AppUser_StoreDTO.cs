...
namespace DMS.Rpc.app_user
{
    public class AppUser_StoreDTO : DataDTO
    {
        ...
        public AppUser_StoreGroupingDTO StoreGrouping { get; set; }
        ...
        public AppUser_StoreDTO(Store Store)
        {
            ...
            this.StoreGrouping = Store.StoreGrouping == null ? null : new AppUser_StoreGroupingDTO(Store.StoreGrouping);
