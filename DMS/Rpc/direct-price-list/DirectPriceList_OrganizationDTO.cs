...
{
    public class DirectPriceList_OrganizationDTO : DataDTO
    {
        ...
        public DirectPriceList_OrganizationDTO() { }
        public DirectPriceList_OrganizationDTO(Organization Organization)
        {
    ...
    public class DirectPriceList_OrganizationFilterDTO : FilterDTO
    {
