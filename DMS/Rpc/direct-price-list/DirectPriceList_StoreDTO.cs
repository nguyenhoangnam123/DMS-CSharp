...
{
    public class DirectPriceList_StoreDTO : DataDTO
    {
        ...
        public DirectPriceList_StoreDTO() { }
        public DirectPriceList_StoreDTO(Store Store)
        {
    ...
    public class DirectPriceList_StoreFilterDTO : FilterDTO
    {
