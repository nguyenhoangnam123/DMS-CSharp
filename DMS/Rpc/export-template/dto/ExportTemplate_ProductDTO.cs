...
namespace DMS.Rpc.export_template.dto
{
    public class ExportTemplate_ProductDTO : DataDTO
    {
        ...
        public ExportTemplate_SupplierDTO Supplier { get; set; }
        public ExportTemplate_TaxTypeDTO TaxType { get; set; }
        public ExportTemplate_UnitOfMeasureDTO UnitOfMeasure { get; set; }
        public ExportTemplate_UnitOfMeasureGroupingDTO UnitOfMeasureGrouping { get; set; }
        public List<ExportTemplate_ProductProductGroupingMappingDTO> ProductProductGroupingMappings { get; set; }
        public ExportTemplate_ProductDTO() { }
        public ExportTemplate_ProductDTO(Product Product)
        {
            this.Id = Product.Id;
            ...
            this.Category = Product.Category == null ? null : new ExportTemplate_CategoryDTO(Product.Category);
            this.ProductType = Product.ProductType == null ? null : new ExportTemplate_ProductTypeDTO(Product.ProductType);
            this.Supplier = Product.Supplier == null ? null : new ExportTemplate_SupplierDTO(Product.Supplier);
            this.TaxType = Product.TaxType == null ? null : new ExportTemplate_TaxTypeDTO(Product.TaxType);
            this.UnitOfMeasure = Product.UnitOfMeasure == null ? null : new ExportTemplate_UnitOfMeasureDTO(Product.UnitOfMeasure);
            this.UnitOfMeasureGrouping = Product.UnitOfMeasureGrouping == null ? null : new ExportTemplate_UnitOfMeasureGroupingDTO(Product.UnitOfMeasureGrouping);
            this.ProductProductGroupingMappings = Product.ProductProductGroupingMappings?.Select(x => new ExportTemplate_ProductProductGroupingMappingDTO(x)).ToList();
            this.Errors = Product.Errors;
        }
    }

    public class ExportTemplate_ProductFilterDTO : FilterDTO
    {
