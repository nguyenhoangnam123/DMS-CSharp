...
{
    public class GeneralMobile_PrintIndirectOrderContentDTO : DataDTO
    {
        ...
        public GeneralMobile_PrintIndirectOrderContentDTO() { }
        public GeneralMobile_PrintIndirectOrderContentDTO(IndirectSalesOrderContent IndirectSalesOrderContent)
        {
