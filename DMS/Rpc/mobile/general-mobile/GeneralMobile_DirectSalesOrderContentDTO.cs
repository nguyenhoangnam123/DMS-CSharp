...
{
    public class GeneralMobile_DirectSalesOrderContentDTO : DataDTO
    {
        ...
        public GeneralMobile_DirectSalesOrderContentDTO() { }
        public GeneralMobile_DirectSalesOrderContentDTO(DirectSalesOrderContent DirectSalesOrderContent)
        {
            ...
            this.EditedPriceStatus = DirectSalesOrderContent.EditedPriceStatus == null ? null : new GeneralMobile_EditedPriceStatusDTO(DirectSalesOrderContent.EditedPriceStatus);
    ...
    public class GeneralMobile_DirectSalesOrderContentFilterDTO : FilterDTO
    {
