...
{
    public class Mobile_ProductGroupingDTO : DataDTO
    {
        ...
        public Mobile_ProductGroupingDTO() { }
        public Mobile_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class Mobile_ProductGroupingFilterDTO : FilterDTO
    {
