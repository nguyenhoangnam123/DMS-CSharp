...
{
    public class Mobile_IndirectSalesOrderPromotionDTO : DataDTO
    {
        ...
        public Mobile_IndirectSalesOrderPromotionDTO() { }
        public Mobile_IndirectSalesOrderPromotionDTO(IndirectSalesOrderPromotion IndirectSalesOrderPromotion)
        {
    ...
    public class Mobile_IndirectSalesOrderPromotionFilterDTO : FilterDTO
    {
