...
{
    public class Mobile_StoreGroupingDTO : DataDTO
    {
        ...
        public Mobile_StoreGroupingDTO() { }
        public Mobile_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class Mobile_StoreGroupingFilterDTO : FilterDTO
    {
