...
{
    public class Mobile_DistrictDTO : DataDTO
    {
        ...
        public Mobile_DistrictDTO() { }
        public Mobile_DistrictDTO(District District)
        {
    ...
    public class Mobile_DistrictFilterDTO : FilterDTO
    {
