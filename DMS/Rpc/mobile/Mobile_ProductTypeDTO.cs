...
{
    public class Mobile_ProductTypeDTO : DataDTO
    {
        ...
        public Mobile_ProductTypeDTO() { }
        public Mobile_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class Mobile_ProductTypeFilterDTO : FilterDTO
    {
