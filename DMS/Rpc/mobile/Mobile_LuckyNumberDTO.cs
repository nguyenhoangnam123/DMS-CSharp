...
{
    public class Mobile_LuckyNumberDTO : DataDTO
    {
        ...
        public Mobile_LuckyNumberDTO() {}
        public Mobile_LuckyNumberDTO(LuckyNumber LuckyNumber)
        {
    ...
    public class Mobile_LuckyNumberFilterDTO : FilterDTO
    {
