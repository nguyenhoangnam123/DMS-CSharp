...
{
    public class Mobile_SurveyQuestionTypeDTO : DataDTO
    {
        ...
        public Mobile_SurveyQuestionTypeDTO() { }
        public Mobile_SurveyQuestionTypeDTO(SurveyQuestionType SurveyQuestionType)
        {
