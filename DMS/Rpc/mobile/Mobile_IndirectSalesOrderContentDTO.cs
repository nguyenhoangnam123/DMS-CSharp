...
{
    public class Mobile_IndirectSalesOrderContentDTO : DataDTO
    {
        ...
        public Mobile_IndirectSalesOrderContentDTO() { }
        public Mobile_IndirectSalesOrderContentDTO(IndirectSalesOrderContent IndirectSalesOrderContent)
        {
    ...
    public class Mobile_IndirectSalesOrderContentFilterDTO : FilterDTO
    {
