...
{
    public class Mobile_OrganizationDTO : DataDTO
    {
        ...
        public Mobile_OrganizationDTO() {}
        public Mobile_OrganizationDTO(Organization Organization)
        {
    ...
    public class Mobile_OrganizationFilterDTO : FilterDTO
    {
