...
{
    public class GeneralKpi_OrganizationDTO : DataDTO
    {
        ...
        public GeneralKpi_OrganizationDTO() { }
        public GeneralKpi_OrganizationDTO(Organization Organization)
        {
    ...
    public class GeneralKpi_OrganizationFilterDTO : FilterDTO
    {
