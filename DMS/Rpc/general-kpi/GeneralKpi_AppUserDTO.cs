...
{
    public class GeneralKpi_AppUserDTO : DataDTO
    {
        ...
        public GeneralKpi_AppUserDTO() { }
        public GeneralKpi_AppUserDTO(AppUser AppUser)
        {
    ...
    public class GeneralKpi_AppUserFilterDTO : FilterDTO
    {
