...
{
    public class IndirectPriceList_OrganizationDTO : DataDTO
    {
        ...
        public IndirectPriceList_OrganizationDTO() { }
        public IndirectPriceList_OrganizationDTO(Organization Organization)
        {
    ...
    public class IndirectPriceList_OrganizationFilterDTO : FilterDTO
    {
