...
{
    public class IndirectPriceList_StoreDTO : DataDTO
    {
        ...
        public IndirectPriceList_StoreDTO() {}
        public IndirectPriceList_StoreDTO(Store Store)
        {
    ...
    public class IndirectPriceList_StoreFilterDTO : FilterDTO
    {
