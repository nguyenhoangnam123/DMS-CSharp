...
{
    public class ShowingWarehouse_OrganizationDTO : DataDTO
    {
        ...
        public ShowingWarehouse_OrganizationDTO() {}
        public ShowingWarehouse_OrganizationDTO(Organization Organization)
        {
    ...
    public class ShowingWarehouse_OrganizationFilterDTO : FilterDTO
    {
