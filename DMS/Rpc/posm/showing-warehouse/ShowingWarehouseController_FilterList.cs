...
namespace DMS.Rpc.posm.showing_warehouse
{
    ...
    {
        [Route(ShowingWarehouseRoute.FilterListDistrict), HttpPost]
        public async Task<List<ShowingWarehouse_DistrictDTO>> FilterListDistrict([FromBody] ShowingWarehouse_DistrictFilterDTO ShowingWarehouse_DistrictFilterDTO)
        {
        ...
        [Route(ShowingWarehouseRoute.FilterListOrganization), HttpPost]
        public async Task<List<ShowingWarehouse_OrganizationDTO>> FilterListOrganization([FromBody] ShowingWarehouse_OrganizationFilterDTO ShowingWarehouse_OrganizationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ShowingWarehouseRoute.FilterListProvince), HttpPost]
        public async Task<List<ShowingWarehouse_ProvinceDTO>> FilterListProvince([FromBody] ShowingWarehouse_ProvinceFilterDTO ShowingWarehouse_ProvinceFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ShowingWarehouseRoute.FilterListStatus), HttpPost]
        public async Task<List<ShowingWarehouse_StatusDTO>> FilterListStatus([FromBody] ShowingWarehouse_StatusFilterDTO ShowingWarehouse_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ShowingWarehouseRoute.FilterListWard), HttpPost]
        public async Task<List<ShowingWarehouse_WardDTO>> FilterListWard([FromBody] ShowingWarehouse_WardFilterDTO ShowingWarehouse_WardFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ShowingWarehouseRoute.FilterListShowingInventory), HttpPost]
        public async Task<List<ShowingWarehouse_ShowingInventoryDTO>> FilterListShowingInventory([FromBody] ShowingWarehouse_ShowingInventoryFilterDTO ShowingWarehouse_ShowingInventoryFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ShowingWarehouseRoute.FilterListAppUser), HttpPost]
        public async Task<List<ShowingWarehouse_AppUserDTO>> FilterListAppUser([FromBody] ShowingWarehouse_AppUserFilterDTO ShowingWarehouse_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ShowingWarehouseRoute.FilterListShowingItem), HttpPost]
        public async Task<List<ShowingWarehouse_ShowingItemDTO>> FilterListShowingItem([FromBody] ShowingWarehouse_ShowingItemFilterDTO ShowingWarehouse_ShowingItemFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            ShowingItemFilter.ERPCode = ShowingWarehouse_ShowingItemFilterDTO.ERPCode;
