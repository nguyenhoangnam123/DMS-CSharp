...
{
    public class ShowingWarehouse_UnitOfMeasureDTO : DataDTO
    {
        ...
        public ShowingWarehouse_UnitOfMeasureDTO() {}
        public ShowingWarehouse_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class ShowingWarehouse_UnitOfMeasureFilterDTO : FilterDTO
    {
