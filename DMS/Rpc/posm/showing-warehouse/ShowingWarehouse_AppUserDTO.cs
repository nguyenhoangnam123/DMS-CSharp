...
{
    public class ShowingWarehouse_AppUserDTO : DataDTO
    {
        ...
        public ShowingWarehouse_AppUserDTO() {}
        public ShowingWarehouse_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ShowingWarehouse_AppUserFilterDTO : FilterDTO
    {
