...
{
    public class Public_ProductTypeDTO : DataDTO
    {
        ...
        public Public_ProductTypeDTO() { }
        public Public_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class Public_ProductTypeFilterDTO : FilterDTO
    {
