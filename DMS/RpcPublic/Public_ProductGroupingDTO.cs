...
{
    public class Public_ProductGroupingDTO : DataDTO
    {
        ...
        public Public_ProductGroupingDTO() { }
        public Public_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class Public_ProductGroupingFilterDTO : FilterDTO
    {
