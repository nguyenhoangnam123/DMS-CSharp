...
{
    public class Public_UnitOfMeasureDTO : DataDTO
    {
        ...
        public Public_UnitOfMeasureDTO() { }
        public Public_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
        ...
        public Public_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
    ...
    public class Public_UnitOfMeasureFilterDTO : FilterDTO
    {
